#!/bin/bash
[200~echo "Setting up React Router for WonderNew..."~
[200~echo "Step 1: Updating project URLs..."
sed -i "s|id: 'cosmic-scale',\s*title: 'Cosmic Scale',\s*url: '#',|id: 'cosmic-scale',\n    title: 'Cosmic Scale',\n    url: '/cosmic-scale',|g" src/data/projects.ts
sed -i "s|id: 'hman-check',\s*title: 'Human Verification',\s*url: '#',|id: 'hman-check',\n    title: 'Human Verification',\n    url: '/human-check',|g" src/data/projects.ts
sed -i "s|id: 'digital-roadtrip',\s*title: 'Digital Roadtrip',\s*url: '#',|id: 'digital-roadtrip',\n    title: 'Digital Roadtrip',\n    url: '/digital-roadtrip',|g" src/data/projects.ts
sed -i "s|id: 'dopamine-clicker',\s*title: 'Dopamine Clicker',\s*url: '#',|id: 'dopamine-clicker',\n    title: 'Dopamine Clicker',\n    url: '/dopamine-clicker',|g" src/data/projects.ts
sed -i "s|id: 'element-fusion',\s*title: 'Element Fusion',\s*url: '#',|id: 'element-fusion',\n    title: 'Element Fusion',\n    url: '/element-fusion',|g" src/data/projects.ts
sed -i "s|id: 'web-museum',\s*title: 'Web Museum',\s*url: '#',|id: 'web-museum',\n    title: 'Web Museum',\n    url: '/web-museum',|g" src/data/projects.ts~
mkdir -p src/pages
